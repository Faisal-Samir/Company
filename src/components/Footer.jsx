...
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-center p-10 bg-blue-500 text-primary-content justify-around flex gap-10">
                <nav>
                ...
                <nav>
                    ...
                    <section className='text-left' id='contactUs'>
                        <div className='flex gap-1 justify-center items-center mb-3'>
                            <ImLocation2 className='w-8 h-8' /><p className=''>Flat No-6/B, Road -9, Block-A, Chandrima  Model <br /> Town,  Dhaka Uddan, Mohammadpur, Dhaka-1207</p>
                        </div>
                        <div className='flex gap-1 items-center mb-3'>
                            <BsFillTelephoneFill className='w-5 h-5' /> <p className='ml-2'>01874 943414, 01531 551577</p>
                        </div>
                        <div className='flex gap-1  items-center mb-3'>
                            <MdMarkEmailUnread className='w-5 h-5' /> <p className='ml-2'>aatradein2015@gmail.com</p>
                        </div>
                    </section>
                ...
                <aside>
                    ...
                    <p className="font-bold">
                        A A Trade International <br />Providing Real state service since 2020
                    </p>
